...
st.title("🐧 น้องอลิซ ผู้ช่วยค้นหาร้าน Fine dining ในกรุงเทพฯ พร้อมให้บริการค่ะ")
...
if "prompt_chain" not in st.session_state:
    st.session_state.prompt_chain = "You act as lady. You are chatbot. You will help customer to answer customer that want to know information about fine dining restaurant in Bangkok. If there question not relate with fine dining restaurant in Bangkok you will tell them Who you are? Please answer the following query in a friendly and informative way: This is question from customer: "
